...
export const TEXT = {
  ...
  ranking: {
    ...
    cheerAward: "곧 열반에 오를 친구들",
    cheerHint: "'힘내요'를 가장 많이 받은 사람이에요. 그만큼 고생하고 있다는 뜻이죠.",
  ...
  manage: {
    ...
    actorRequired: "행위자를 입력해주세요.",
    nameRequired: "행위명을 입력해주세요.",
    save: "저장",
    cancel: "취소",
    delete: "삭제",
  ...
  cheer: {
    ...
    button: "💪 힘내요",
    sent: "힘내라고 전했어요.",
    cooldown: "방금 보냈어요. 조금 이따 다시 보내주세요.",
    self: "본인에게는 보낼 수 없어요.",
    failed: "보내지 못했어요. 잠시 후 다시 시도해주세요.",
    pushTitle: (name: string) => `${name}님이 힘내라고 했어요!`,
    pushBody: "그 소리들, 참느라 고생 많으시죠.",
  },
} as const;
...
export const PATCH_NOTES = [
  {
    ...
    date: "2026-09-23",
    items: [
      "메인에서 좌우로 스와이프하면 다른 사람 화면도 넘겨볼 수 있어요 (구경만 가능해요).",
      "다른 사람 화면에서 '힘내요' 버튼을 누르면 그 사람에게 알림이 가요. 그 소리들 참느라 고생이 많으니까요.",
      "랭킹에 '곧 열반에 오를 친구들'이 추가됐어요 — 힘내요를 가장 많이 받은 순이에요.",
    ],
  },
  {
    version: "2.10.0",
    date: "2026-09-23",
    items: [
      "연속으로 빠르게 눌러도 숫자가 꼬이지 않게 고쳤어요.",
      "행위자·항목 순서가 저절로 바뀌던 문제를 고쳤어요.",
      "이제 내 카드는 나만 누르고 꾸밀 수 있어요 — 다른 사람 페이지에서는 구경만 가능해요.",
      "필수 항목을 비워두고 저장하면 알려주고 그 칸으로 옮겨가요.",
    ],
  },
  {
    version: "2.9.0",
    date: "2026-09-23",
    items: [
      "내 페이지에서 항목관리(PIN) 없이 바로 새 행위자/항목을 만들 수 있어요.",
      "카드의 ⋯ 메뉴에서 내 항목의 행위자/행위명을 고치거나 삭제할 수 있어요.",
    ],
  },
  {
    version: "2.8.0",
    date: "2026-09-23",
    items: [
      "현황의 '오늘 친구들'이 등록한 이미지가 보이는 미니 카드로 바뀌었어요. 항목이 5개 넘으면 옆으로 넘겨서 볼 수 있어요.",
    ],
  },
  {
    version: "2.7.0",
